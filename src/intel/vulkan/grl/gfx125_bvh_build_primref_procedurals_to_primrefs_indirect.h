...
mov(8)          g29.1<2>F       g3.1<0,1,0>F                    { align1 1Q compacted };
mov(8)          g31.1<2>F       g3.1<0,1,0>F                    { align1 2Q compacted };
and(16)         g10<1>UD        g3.2<0,1,0>UD   0x00ffffffUD    { align1 1H };
mov(8)          g52<2>F         g2.6<0,1,0>F                    { align1 1Q F@6 compacted };
mov(8)          g54<2>F         g2.6<0,1,0>F                    { align1 2Q F@6 compacted };
mov(8)          g23<2>F         g2<0,1,0>F                      { align1 1Q F@6 compacted };
mov(8)          g25<2>F         g2<0,1,0>F                      { align1 2Q F@6 compacted };
mov(8)          g29<2>F         g3<0,1,0>F                      { align1 1Q F@6 compacted };
mov(8)          g31<2>F         g3<0,1,0>F                      { align1 2Q F@6 compacted };
sync nop(1)                     null<0,1,0>UB                   { align1 WE_all 1N F@1 };
send(16)        g36UD           g29UD           nullUD          0x08201582                0x00000000
                            ugm MsgDesc: ( load_cmask, a64, d32, x, L1STATE_L3MOCS dst_len = 2, src0_len = 4, src1_len = 0 flat )  base_offset 0  { align1 1H $2 };
mov(8)          g27.1<2>F       g2.3<0,1,0>F                    { align1 1Q I@5 };
mov(8)          g29.1<2>F       g2.3<0,1,0>F                    { align1 2Q $2.src };
mov(8)          g31.1<2>F       g2.5<0,1,0>F                    { align1 1Q $2.src };
mov(8)          g33.1<2>F       g2.5<0,1,0>F                    { align1 2Q };
mov(8)          g27<2>F         g2.2<0,1,0>F                    { align1 1Q F@4 compacted };
mov(8)          g29<2>F         g2.2<0,1,0>F                    { align1 2Q F@4 compacted };
mov(8)          g31<2>F         g2.4<0,1,0>F                    { align1 1Q F@4 compacted };
mov(8)          g33<2>F         g2.4<0,1,0>F                    { align1 2Q F@4 compacted };
...
mach(8)         g52<1>UD        g42<1,1,0>UD    g48<1,1,0>UD    { align1 1Q $3.src compacted AccWrEnable };
...
add(16)         g60<1>D         g44<1,1,0>D     g54<1,1,0>D     { align1 1H @3 $3.dst compacted };
add(16)         g56.1<2>UW      g56.1<16,8,2>UW g108<16,8,2>UW  { align1 1H I@3 };
mach(8)         g53<1>UD        g43<8,8,1>UD    g49<8,8,1>UD    { align1 2Q $3.src AccWrEnable };
...
add3(16)        g64<1>D         g46<8,8,1>D     g58<8,8,1>D     -g62<1,1,1>D { align1 1H @2 $3.dst };
...
mov(8)          g54<2>UD        g73<4,4,1>UD                    { align1 1Q $4.src };
mov(8)          g56<2>UD        g74<4,4,1>UD                    { align1 2Q $4.src };
mov(8)          g54.1<2>UD      g77<4,4,1>UD                    { align1 1Q I@2 };
mov(8)          g56.1<2>UD      g78<4,4,1>UD                    { align1 2Q I@2 };
cmp.l.f0.0(16)  g79<1>F         (abs)g67<1,1,0>F 0x7f800000F  /* infF */ { align1 1H $4.dst compacted };
...
cmp.l.f0.0(16)  g89<1>F         (abs)g78<1,1,0>F 0x7f800000F  /* infF */ { align1 1H $5.dst compacted };
...
sel.ge(16)      g107<1>F        g69<1,1,0>F     g80<1,1,0>F     { align1 1H $5.dst compacted };
sync nop(1)                     null<0,1,0>UB                   { align1 WE_all 1N $1.src };
cmp.l.f0.0(16)  g91<1>F         (abs)g71<1,1,0>F 0x7f800000F  /* infF */ { align1 1H $4.dst compacted };
...
add(8)          g121<1>D        g23<8,4,2>D     36D             { align1 1Q compacted };
add(8)          g122<1>D        g25<8,4,2>D     36D             { align1 2Q compacted };
...
mov(8)          g55<2>UD        g121<4,4,1>UD                   { align1 1Q $5.src };
mov(8)          g57<2>UD        g122<4,4,1>UD                   { align1 2Q $5.src };
...
LABEL4:
add(16)         g126<1>D        g119<1,1,0>D    g21<0,1,0>D     { align1 1H @3 $5.dst compacted };
...
mov(8)          g35<1>UD        g31.1<8,4,2>UD                  { align1 1Q F@3 };
mov(8)          g36<1>UD        g33.1<8,4,2>UD                  { align1 2Q F@2 };
...
mov(8)          g60<2>UD        g44<4,4,1>UD                    { align1 1Q $5.src };
...
cmp.l.f0.0(16)  g52<1>UD        g50<1,1,0>UD    g44<1,1,0>UD    { align1 1H I@1 compacted };
mov(8)          g61<2>UD        g50<4,4,1>UD                    { align1 1Q $5.src };
mov(8)          g63<2>UD        g51<4,4,1>UD                    { align1 2Q $5.src };
sync nop(1)                     null<0,1,0>UB                   { align1 WE_all 1N $5.src };
add(16)         g54<1>D         -g52<1,1,0>D    g48<1,1,0>D     { align1 1H I@3 compacted };
...
add(16)         g55<1>F         g4<1,1,0>F      g12<1,1,0>F     { align1 1H I@3 compacted };
cmp.ge.f0.0(16) g61<1>F         g12<1,1,0>F     g4<1,1,0>F      { align1 1H $6.src compacted };
mov(16)         g79<1>F         0x7f800000F      /* infF */     { align1 WE_all 1H compacted };
mov(16)         g79<1>F         g4<1,1,0>F                      { align1 1H compacted };
mov(16)         g81<1>F         0x7f800000F      /* infF */     { align1 WE_all 1H $5.src compacted };
mov(16)         g81<1>F         g6<1,1,0>F                      { align1 1H compacted };
mov(16)         g83<1>F         0x7f800000F      /* infF */     { align1 WE_all 1H $5.src compacted };
...
mov(16)         g87<1>F         0xff800000F      /* -infF */    { align1 WE_all 1H $6.src compacted };
mov(16)         g87<1>F         g14<1,1,0>F                     { align1 1H compacted };
sync nop(1)                     null<0,1,0>UB                   { align1 WE_all 1N $0.src };
mov(16)         g89<1>F         0xff800000F      /* -infF */    { align1 WE_all 1H $6.src compacted };
mov(16)         g89<1>F         g16<1,1,0>F                     { align1 1H compacted };
add(16)         g57<1>F         g6<1,1,0>F      g14<1,1,0>F     { align1 1H $5.src compacted };
sync nop(1)                     null<0,1,0>UB                   { align1 WE_all 1N $5.src };
sync nop(1)                     null<0,1,0>UB                   { align1 WE_all 1N $4.src };
sync nop(1)                     null<0,1,0>UB                   { align1 WE_all 1N $6.src };
...
mov(4)          g54<4>UD        g83.3<8,2,4>UD                  { align1 WE_all 1N $5.src };
...
mov(8)          g92<2>UD        g111<4,4,1>UD                   { align1 1Q $7.src };
...
mov(4)          g9<4>UD         g118.1<8,2,4>UD                 { align1 WE_all 1N $5.src };
...
mov(4)          g81<4>UD        g1.1<8,2,4>UD                   { align1 WE_all 1N $7.src };
...
mov(8)          g102<2>UD       g20<4,4,1>UD                    { align1 1Q $8.src };
...
static const uint32_t gfx125_bvh_build_primref_procedurals_to_primrefs_indirect_code[] = {
    ...
    0x211d0061, 0x001103cc, 0x2a1f0061, 0x001103cc,
    0x00040065, 0x0a058220, 0x02000344, 0x00ffffff,
    0x21341661, 0x0011026c, 0x2a361661, 0x0011026c,
    0x21171661, 0x00110204, 0x2a191661, 0x00110204,
    0x211d1661, 0x00110304, 0x2a1f1661, 0x00110304,
    0x80001101, 0x00000000, 0x00000000, 0x00000000,
    0x00044231, 0x24140000, 0xfb041d24, 0x00040000,
    0x00031d61, 0x1b260aa0, 0x00000264, 0x00000000,
    0x00133261, 0x1d260aa0, 0x00000264, 0x00000000,
    0x00033261, 0x1f260aa0, 0x000002a4, 0x00000000,
    0x00130061, 0x21260aa0, 0x000002a4, 0x00000000,
    0x211b1461, 0x00110244, 0x2a1d1461, 0x00110244,
    0x211f1461, 0x0011025c, 0x2a211461, 0x0011025c,
    ...
    0x00000360, 0x000002f0, 0x00044331, 0x2c440000,
    0xfb043424, 0x003c0000, 0x00032341, 0x20010220,
    0x01462a05, 0x00563006, 0x00042341, 0x36050660,
    0x01462a05, 0x00563006, 0x00040041, 0x6b050660,
    0x01462a05, 0x00563016, 0x00042341, 0x38050660,
    0x01462a05, 0x00563206, 0x3e343349, 0x30002a03,
    ...
    0xa03cb340, 0x36002c02, 0x00041b40, 0x38160110,
    0x01563816, 0x00566c06, 0x00133349, 0x35050222,
    0x02462b05, 0x00463105, 0x273e1b70, 0x2c003c03,
    0xa0490040, 0x01003c03, 0xa03a1b40, 0x38003402,
    0x274b1a70, 0x3c004903, 0x0004a352, 0x40040e68,
    ...
    0x00044431, 0x41440000, 0xfb043524, 0x003c0000,
    0x00033461, 0x36060220, 0x00344905, 0x00000000,
    0x00133461, 0x38060220, 0x00344a05, 0x00000000,
    0x00031a61, 0x36260220, 0x00344d05, 0x00000000,
    0x00131a61, 0x38260220, 0x00344e05, 0x00000000,
    0xe74f2470, 0x7f834300, 0xe7512470, 0x7f834100,
    0xe7552470, 0x7f834500, 0x20531265, 0x51004f03,
    0x80001901, 0x00000000, 0x00000000, 0x00000000,
    0x00044531, 0x4e240000, 0xfb043624, 0x000c0000,
    0x20570965, 0x55005303, 0x80003001, 0x00000000,
    0x00000000, 0x00000000, 0xe7592570, 0x7f834e00,
    0x27650062, 0x4e004300, 0x25690062, 0x4e004300,
    0x256b2562, 0x50004500, 0x80003101, 0x00000000,
    0x00000000, 0x00000000, 0xe75b2470, 0x7f834700,
    ...
    0x000000c0, 0x000000c0, 0xa1790040, 0x024e1703,
    0xaa7a0040, 0x024e1903, 0x00031a70, 0x7b050220,
    0x52467905, 0x00441706, 0x00131a70, 0x7c050220,
    0x52467a05, 0x00441906, 0x00033561, 0x37060220,
    0x00347905, 0x00000000, 0x00133561, 0x39060220,
    ...
    0x00000000, 0x00000000, 0x00044531, 0x15140000,
    0xfb183724, 0x01003b14, 0x00040025, 0x00004600,
    0x00000000, 0x00000010, 0xa07eb540, 0x15107702,
    ...
    0xe0140068, 0x01b07e03, 0x00031361, 0x23050220,
    0x00441f26, 0x00000000, 0x00131261, 0x24050220,
    ...
    0x52462c05, 0x00441f06, 0x00033561, 0x3c060220,
    ...
    0x80001901, 0x00000000, 0x00000000, 0x00000000,
    0x00044531, 0x00000000, 0xfb0c3c24, 0x003c0444,
    0xa0320040, 0x01002c03, 0x80003401, 0x00000000,
    0x00000000, 0x00000000, 0x27341970, 0x2c003203,
    0x00033561, 0x3d060220, 0x00343205, 0x00000000,
    0x00133561, 0x3f060220, 0x00343305, 0x00000000,
    0x80003501, 0x00000000, 0x00000000, 0x00000000,
    0xa0361b40, 0x30023402, 0x00131961, 0x3f260220,
    ...
    0x00000000, 0x00000000, 0x20371b40, 0x0c000400,
    0x253d3670, 0x04000c00, 0xa34f0061, 0x7f810000,
    0x604f0061, 0x00100400, 0xa3513561, 0x7f810000,
    0x60510061, 0x00100600, 0xa3533561, 0x7f810000,
    0x60530061, 0x00100800, 0xa3550061, 0xff810000,
    0x60550061, 0x00100c00, 0xa3573661, 0xff810000,
    0x60570061, 0x00100e00, 0x80003001, 0x00000000,
    0x00000000, 0x00000000, 0xa3593661, 0xff810000,
    0x60590061, 0x00101000, 0x20393540, 0x0e000600,
    0x80003501, 0x00000000, 0x00000000, 0x00000000,
    ...
    0x5a445306, 0x00442c06, 0x80003501, 0x00000000,
    ...
    0x5a427707, 0x00427907, 0x80002501, 0x00000000,
    ...
    0x26464105, 0x00000000, 0x80023561, 0x36070220,
    ...
    0x26466905, 0x00000000, 0x00033761, 0x5c060220,
    ...
    0x60010061, 0x00104d00, 0x80003701, 0x00000000,
    0x00000000, 0x00000000, 0x00040070, 0x00018220,
    0x52462805, 0x00000003, 0x80031661, 0x06060220,
    0x00447626, 0x00000000, 0x80003601, 0x00000000,
    ...
    0x5a447606, 0x00440606, 0x80003601, 0x00000000,
    ...
    0x00443f06, 0x00000000, 0x80003501, 0x00000000,
    0x00000000, 0x00000000, 0x80021d61, 0x0b070220,
    0x00427647, 0x00000000, 0x80023561, 0x09070220,
    ...
    0x5a422a07, 0x00422c07, 0x80003701, 0x00000000,
    0x00000000, 0x00000000, 0x80021d61, 0x53070220,
    0x00420147, 0x00000000, 0x80023761, 0x51070220,
    ...
    0x00441926, 0x00000000, 0x80003801, 0x00000000,
    ...
    0x26460e05, 0x00000000, 0x00033861, 0x66060220,
...
const char *gfx125_bvh_build_primref_procedurals_to_primrefs_indirect_sha1 = "ee3b0589e969168d674cd371f3f008d4fa9ac557";
